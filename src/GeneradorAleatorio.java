...
public class GeneradorAleatorio {
    ...
    private final String[] nombresPokemon = {
            "Charmander", "Squirtle", "Bulbasaur", "Pikachu", "Sandshrew", "Pidgey",
            "Growlithe", "Poliwag", "Oddish", "Magnemite", "Diglett", "Zubat", "Snorlax"
    };

    private final String[] nombresAtaques = {
            "Placaje", "Lanzallamas", "Pistola Agua", "Impactrueno", "Latigazo", "Tornado", "Terremoto", "Rayo Solar", "Puño", "Machetazo",
            "Navajazo", "Correazo", "Llave"
    };

    private final String[] tiposDanio = {"Físico", "Especial"};

    private final Random random = new Random();

    public List<Pokemon> generarEquipoAleatorio() {
